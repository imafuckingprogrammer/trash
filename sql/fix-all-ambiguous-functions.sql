-- Comprehensive fix for ALL ambiguous column reference issues
-- This will drop and recreate all functions that might have ambiguous references
...
-- 1. Create the update_book_rating function (singular, with UUID parameter)
...
-- 2. Create the trigger function that calls update_book_rating
...
-- 3. Create the main update_book_ratings function (plural, for triggers)
...
-- 4. Fix the update_list_item_count function
...
-- 5. Fix the update_parent_comment_count function
...
-- 6. Fix the update_parent_like_count function
